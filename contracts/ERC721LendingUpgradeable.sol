...
contract ERC721Lending is ERC721HolderUpgradeable, ReentrancyGuardUpgradeable, AccessControlUpgradeable {
    ...
    function createOffer(uint256 nftId, address nftAddress, uint256 liquidation, uint256 fee) external nonReentrant() {
        ...
        require(IERC721Upgradeable(nftAddress).ownerOf(nftId) == msg.sender, "Not the owner of the NFT");
    ...
    function cancelOffer(uint256 offerId) external nonReentrant() {
        ...
        require(IERC721Upgradeable(offers[offerId].nft).ownerOf(offers[offerId].nftId) == address(this), "The Protocol does not have the NFT");
    ...
    function repayOffer(uint256 offerId) external nonReentrant() {
        ...
        require(IERC721Upgradeable(offers[offerId].nft).ownerOf(offers[offerId].nftId) == msg.sender, "Borrower is not owner of the NFT");
        ...
        IERC721Upgradeable(offers[offerId].nft).safeTransferFrom(msg.sender, address(this), offers[offerId].nftId);
